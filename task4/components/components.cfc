<cfcomponent>
    <cffunction name="textField" access="remote" returntype="struct">
        ...
        <cfset LastMonth = dateAdd("d", -1, dateAdd("m", -1 , today)-1)>
        <cfset lastM = dateFormat("#LastMonth#")>
        <cfset dateStruct=structNew()>
        <cfset dateStruct.today = "#today#">
        <cfset dateStruct.month = "#month#">
        <cfset dateStruct.monthWords = "#monthWords#">
        <cfset dateStruct.friday = "#friday#">
        <cfset dateStruct.lastM = "#lastM#">
