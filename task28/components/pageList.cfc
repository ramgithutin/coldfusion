<cfcomponent>
    <cffunction  name="pagelist" access="public" returnType="query">
    ...
    <cffunction  name="descripition" access="public" returnType="query">
    ...
    <cffunction  name="descLists" access="public" returnType="query">
